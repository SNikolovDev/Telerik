        ...
        private string AddVehicle(VehicleType type, string make, string model, decimal price, string additionalParam)
        {
            ...
            switch (type)
            {
                case VehicleType.Car:
                    ...
                    vehicle = (IVehicle)this.Repository.CreateCar(make, model, price, seats);
                    break;
                case VehicleType.Motorcycle:
                    vehicle = (IVehicle)this.Repository.CreateMotorcycle(make, model, price, additionalParam);
                    break;
                case VehicleType.Truck:
                    int weightCapacity = this.ParseIntParameter(additionalParam, "weightCapacity");
                    vehicle = (IVehicle)this.Repository.CreateTruck(make, model, price, weightCapacity);
                    break;
                default:
