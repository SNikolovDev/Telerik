...
namespace Cosmetics.Tests.Commands
{
    ...
    public class CreateCategoryCommandTests
    {
        ...
        {
            // Arrange
            List<string> commandParameters = new List<string>() { TestData.CategoryData.VALID_NAME };
        ...
        {
            ICommand command = new CreateCategoryCommand(new List<string>() { TestData.CategoryData.VALID_NAME }, repository);
            command.Execute();
