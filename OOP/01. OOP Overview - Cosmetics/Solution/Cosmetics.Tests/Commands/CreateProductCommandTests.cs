...
namespace Cosmetics.Tests.Commands
{
    ...
    public class CreateProductCommandTests
    {
        ...
        {
            // Arrange
            List<string> commandParameters = new List<string>() { TestData.ProductData.VALID_NAME, TestData.ProductData.VALID_BRAND_NAME, "2", GenderType.Unisex.ToString() };
        ...
        {
            // Arrange
            ICommand command = new CreateProductCommand(new List<string>() { TestData.ProductData.VALID_NAME, TestData.ProductData.VALID_BRAND_NAME, "2", GenderType.Unisex.ToString() }, repository);
            command.Execute();
