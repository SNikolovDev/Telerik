...
namespace Boarder.Models
{
    public abstract class BoardItem
    {
        ...
        private readonly List<EventLog> eventLog = new List<EventLog>();
        ...
        public List<EventLog> EventLog => new List<EventLog>(this.eventLog);
        ...
        {
            return string.Join(Environment.NewLine, this.eventLog.Select(e => e.ViewInfo()));
        }

        protected void AddEventLog(string desc)
        {
            this.eventLog.Add(new EventLog(desc));
        }
